  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
        <div>
          <h1 style={{ fontSize: '18px', fontWeight: 500, color: 'var(--c-text-primary)', margin: '0 0 2px' }}>Adicionales</h1>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
            <thead>
              <tr style={{ borderBottom: '0.5px solid var(--c-border)' }}>
                ...
                <th style={{ textAlign: 'left', padding: '10px 16px', color: 'var(--c-text-secondary)', fontWeight: 500 }}>Convenio</th>
                ...
                <th style={{ textAlign: 'left', padding: '10px 16px', color: 'var(--c-text-secondary)', fontWeight: 500 }}>Valor</th>
            ...
            <tbody>
              {adicionalesFiltrados.map((a, i) => (
                <tr key={a.id} style={{
                  borderBottom: i < adicionalesFiltrados.length - 1 ? '0.5px solid var(--c-elevated)' : 'none',
                }}>
                  ...
                  <td style={{ padding: '10px 16px', color: 'var(--c-text-primary)', fontWeight: 500 }}>{a.descripcion}</td>
                  <td style={{ padding: '10px 16px', color: 'var(--c-text-secondary)' }}>
                    {a.convenios?.descripcion || <span style={{ color: 'var(--c-text-muted)' }}>Todos</span>}
                  </td>
                  <td style={{ padding: '10px 16px', color: 'var(--c-text-secondary)' }}>
                  ...
                  <td style={{ padding: '10px 16px' }}>
                    <span style={{
                      background: a.activo ? 'var(--c-green-bg)' : 'var(--c-red-bg)',
                      color: a.activo ? 'var(--c-green)' : 'var(--c-red)',
                      fontSize: '11px', padding: '2px 8px', borderRadius: '4px',
                    }}>
