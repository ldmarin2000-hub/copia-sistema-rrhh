          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
            ...
            <tbody>
              {ausencias.map((a, i) => {
                ...
                return (
                  <tr key={a.id} style={{ borderBottom: i < ausencias.length - 1 ? '0.5px solid var(--c-elevated)' : 'none' }}>
                    <td style={{ padding: '10px 16px', color: 'var(--c-text-primary)', fontWeight: 500 }}>
                    ...
                    <td style={{ padding: '10px 16px', color: 'var(--c-blue)' }}>{dias}</td>
                    ...
                    <td style={{ padding: '10px 16px', textAlign: 'right' }}>
                      ...
                      <button onClick={() => abrirEditar(a)} style={{ background: 'transparent', border: 'none', color: 'var(--c-text-secondary)', cursor: 'pointer', fontSize: '12px', padding: '4px 8px' }}>Editar</button>
                      <button onClick={() => eliminar(a)} style={{ background: 'transparent', border: 'none', color: 'var(--c-red)', cursor: 'pointer', fontSize: '12px', padding: '4px 8px' }}>Eliminar</button>
                    </td>
                  </tr>
                )
              })}
